...
document.querySelector('.b-5').onclick = function () {
    document.querySelector('.out-5').textContent = t5('Vadim');
}
...
function t7(a = 0, b = 255) {
    let x = Math.floor(a + Math.random() * (b + 1 - a)),
        y = Math.floor(a + Math.random() * (b + 1 - a)),
        z = Math.floor(a + Math.random() * (b + 1 - a));
